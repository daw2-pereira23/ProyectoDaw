              ...
              <div class="card-body px-4 py-5 px-md-5">
                ...
                <form>
                  ...
                  <div class="justify-content-center d-flex">
                    <button type="submit" class="btn btn-primary btn-block mb-4 justify-content-center">
                      Iniciar Sesion
                    </button>
                  </div>
            ...
            <div class="card bg-glass">
              <div class="card-body px-4 py-5 px-md-5">
                <form>
                  ...
                  <!-- Register buttons -->
                  <div class="text-center">
                   <button id="buton1" class="transparent-bottons"><a><p class="text" id="inicioSesion">Ya tengo cuenta, iniciar sesion</p></a></button> 
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="botones white-color" data-dismiss="modal">Guardar cambios</button>
          </div>
        </div>
      </div>
    </div>
...
const footer = {
  template: `
    <nav class="navbar navbar-light bg-light d-flex justify-content-center align-items-center">
        ...
        <div class="mt-1 ps-5">
            <i class="fa-solid fa-calendar-days logos"></i>
        </div>
    </nav>
    `
};
